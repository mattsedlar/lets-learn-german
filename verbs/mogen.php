...
<html> 
    ...
    <head> 
        ...
        <title>Let's Learn German Together - M&ouml;gen (To Like)</title> 
    ...
    <?php include_once("../includes/analyticstracking.php") ?>  
        ...
        <div class="app_window"> 
            ...
            <p class="sec_title">Verbs - M&ouml;gen (To Like)</p> 
                ...
                <div id="test_space"> 
                    ...
                    <p>Match the conjugation with the pronoun by dragging and dropping into the empty space.<br/><small>(Requires browsers supporting HTML5)</small><br/>&nbsp;</p> 
