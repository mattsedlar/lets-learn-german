...
<html>
	...
	<head>
		...
		<title>Let's Learn German Together - Gehen (To Go)</title>
		...
		var sentence_noun = "nach Berlin";

                // I'm going to set translation options here
                var i_conj = "am going";
                var it_conj = "is going";
                var we_conj = "are going";
		...
		<div class="app_window">
			...
			<p class="sec_title">Verbs - Haben (To Have)</p>
				...
				<div id="test_space">
					...
					<!-- Have to override style for this particular sentence -->
					<div id="columns" style="width: 500px;">
					...
					<div id="column" style="width: 210px" class="columnC"><header></header></div>
					</div>

					<p>&nbsp;</p>
                                        <p>&nbsp;</p>
                                        <p>&nbsp;</p>
                                        <p id="translation"> to Berlin.</p>
					<p>&nbsp;</p>
