...
<html>
	...
	<head>
		...
		<title>Let's Learn German Together - Sagen (To Say)</title>
		...
		var sentence_noun = "&sbquo;Hallo!&rsquo;";
	...
	<?php include_once("../includes/analyticstracking.php") ?>
		...
		<div class="app_window">
			...
			<p class="sec_title">Verbs - Sagen (To Say)</p>
				...
				<div id="test_space">
					...
					<p>&nbsp;</p>
                                        <p>&nbsp;</p>
                                        <p>&nbsp;</p>
                                        <p id="translation"> &sbquo;Hello!&rsquo;</p>
					<p>&nbsp;</p>
